...
namespace mydak {
    ...
    struct database {
        ...
        asio::awaitable<std::uint64_t> add_user(const std::array<char, proto::E2E_KEYS_L>& public_key);
        ...
        std::uint64_t get_db_index(const std::array<char, proto::E2E_KEYS_L>& public_key);
